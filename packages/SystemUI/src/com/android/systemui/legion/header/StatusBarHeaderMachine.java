...
package com.android.systemui.legion.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.legion.header.STATUS_BAR_HEADER_UPDATE";

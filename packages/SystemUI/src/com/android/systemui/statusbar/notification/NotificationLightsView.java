...
public class NotificationLightsView extends RelativeLayout {
    ...
    public void animateNotification(boolean mNotification) {
        ...
        if (mAccentColorLeft) lColor = getResources().getColor(R.color.accent_tint_color_selector);
        ...
        if (mAccentColorRight) rColor = getResources().getColor(R.color.accent_tint_color_selector);
